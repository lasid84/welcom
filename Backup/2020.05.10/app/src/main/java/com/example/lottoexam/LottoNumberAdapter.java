...
public class LottoNumberAdapter extends BaseAdapter {
    ...
    public LottoNumberAdapter(List<LottoNumber> Data, String _clickFlag) {

        this.mData = Data;
        this.mclickFlag = _clickFlag;
    }
        ...
        if (mclickFlag == "N") {
            ...
            switch (lottoNumber.getmColor())
            {
                ...
                case 4:
                    ...
                    break;
                default:
                    holder.LottoNo.setBackgroundResource(R.drawable.circle_plus);
                    break;
            }
        }
